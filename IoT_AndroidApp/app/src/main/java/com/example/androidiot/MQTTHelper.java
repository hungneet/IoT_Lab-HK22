...
public class MQTTHelper {
    ...
    public final String[] arrayTopics = {"hungneet/feeds/sensor1", "hungneet/feeds/sensor2", "hungneet/feeds/sensor3", "hungneet/feeds/button1",
            "hungneet/feeds/button2", "hungneet/feeds/button3"};
    final String username = "hungneet";
    final String password = "aio_Cmey318WvBHLosiwovqhEZqoqyJI";
